...
interface TopicsSorterProps {
  currentSort: TopicsSortModel;
  onChange: (sort: TopicsSortModel) => void;
  itemsPerPage: number;
...
export function TopicsSorter({ currentSort, onChange, itemsPerPage, onItemsPerPageChange }: TopicsSorterProps) {
  const handleSortByChange = (value: string) => {
    onChange({
      ...currentSort,
      sortBy: value as TopicsSortModel["sortBy"],
    });
  };
      ...
      <Select value={currentSort.sortBy} onValueChange={handleSortByChange}>
        ...
        <SelectContent>
          <SelectGroup>
            ...
            <SelectItem value="name">Nazwa tematu</SelectItem>
          </SelectGroup>
          <SelectGroup>
